package ca.ypg.pdavid.com.yp_dine.dummy;
...
public class DummyContent {
	...
	static {
		...
		addItem(new DummyItem("20", "Item 3"));
		addItem(new DummyItem("21", "Item 3"));
		addItem(new DummyItem("22", "Item 3"));
		addItem(new DummyItem("23", "Item 3"));
		addItem(new DummyItem("24", "Item 3"));
		addItem(new DummyItem("25", "Item 3"));
	}
